...
수렴이 일어나는 12개 커널 전반에서, LLM은 LFBO 예산의 대략 첫 약 7% 안에서 자신의 정체 구간에 도달합니다. grouped GEMM(g=4, m=512)의 경우, 같은 커널 성능에서 LFBO보다 18배 더 적은 구성을 사용합니다.
