...
궁금한 점이 있으신가요? 2026년 7월 22일 오전 11시(PT)에 진행되는 라이브 Q&A에 참여해보세요. Alban Desmaison, Andrey Talman, Piotr Bialecki이 패널로, Chris Gottbrath가 모더레이터로 참여합니다. 이번 릴리즈에 대한 간략한 소개와 함께 여러분의 질문에 실시간으로 답변해 드립니다. [지금 등록하기](https://pytorch.org/event/pytorch-2-13-release-live-qa/)
